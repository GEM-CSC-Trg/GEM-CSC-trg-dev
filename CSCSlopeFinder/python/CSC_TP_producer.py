...
if options.era.startswith('Run2'):
  ...
  cond_data_run3 = {
    ...
    'Run3_2024': '140X_dataRun3_Prompt_v4', #for Muon Run2024 H .. on
  }
...
if options.sampleType == 'data':
  ...
  cond = cond_mc[options.era] # check GT 130X_dataRun3_Prompt_v4
else:
...
process.GlobalTag = GlobalTag(process.GlobalTag, cond)
####### ERA Stuff Setup END ########



## running on unpacked data, or after running the unpacker
if not options.sampleType == 'mc' or options.unpack:
