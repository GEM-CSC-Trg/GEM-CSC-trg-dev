...
options.register("runLocal", False, VarParsing.multiplicity.singleton, VarParsing.varType.bool,
                 "if run in loca, set true")
...
lut_dir = "../luts" if options.runLocal else "luts"
process.GEMCSCBendingAngleTester = cms.EDAnalyzer('GEMCSCBendingAngleTester',
	process.MuonServiceProxy,
        ...
        luts_folder = cms.string(lut_dir), #For local running
